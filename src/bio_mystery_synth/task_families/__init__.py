...
from bio_mystery_synth.task_families.metagenomic_enzyme import METAGENOMIC_ENZYME_FAMILY
...
from bio_mystery_synth.task_families.utr_regulatory_assay import UTR_REGULATORY_ASSAY_FAMILY

__all__ = [
    "CRISPR_LINKAGE_FAMILY",
    "DNA_MOTIF_FAMILY",
    "FAMILIES",
    "METAGENOMIC_ENZYME_FAMILY",
    "PROTEIN_BRIDGE_FAMILY",
    "PROTEIN_STRUCTURE_FAMILY",
    "RECOMBINATION_FAMILY",
    "RNA_STRUCTURE_FAMILY",
    "UTR_REGULATORY_ASSAY_FAMILY",
    "get_family",
]
